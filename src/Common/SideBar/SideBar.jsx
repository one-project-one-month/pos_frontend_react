  ...
  return (
    <aside className="sideBarSection">
      <div className="tracking-wide flex flex-col gap-3 w-full justify-start items-start">
        ...
        <NavLink to={"/dashboard"} className="rounded-r-full py-1 text-[#e6e6eb] cursor-pointer menu-item flex justify-start px-4 items-center gap-3 w-[90%]">
        ...
        <div className="flex flex-col gap-1 justify-start items-center h-auto w-[90%]">
          ...
          >
            <NavLink to={"/add-new-invoice"} className="rounded-r-full py-1 text-[#e6e6eb] cursor-pointer menu-item flex justify-start px-[23px] items-center gap-3 w-full">
