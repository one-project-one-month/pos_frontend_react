...
const Editform = ({newShopCode,newShopName,newShopAddress,newShopmobileNo,changeHandler,discardChanges,submitHandler}) => {
  return (
    <>
      ...
      <div className="fixed inset-0 z-10 w-screen overflow-y-auto flex items-center justify-center">
        <form className="w-[600px] mx-auto bg-white p-6 rounded-lg border border-gray-100" onSubmit={submitHandler}>
          ...
          <div className="w-full px-3 mb-6 ">
            ...
            {!newShopCode &&  <p className="text-red-500 text-xs italic">Please fill out this field.</p>}
          </div>
          <div className="w-full px-3 mb-6 ">
            <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" htmlFor="grid-first-name">
              Shop Name
          ...
          <div className='flex items-center gap-3 justify-end'>
            ...
            <button type='submit' className="py-2.5 px-4 ms-2 text-sm font-medium text-white bg-blue-500 rounded-lg  hover:bg-blue-700 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
              Save
            </button>
          </div>
        </form>
